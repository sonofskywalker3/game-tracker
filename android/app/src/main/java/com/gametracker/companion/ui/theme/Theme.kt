package com.gametracker.companion.ui.theme
...
// Branded Game Tracker dark palette — an indigo/violet primary with a warm amber
...
private val GameTrackerDark = darkColorScheme(
    primary            = Indigo,
...
@Composable
fun GameTrackerTheme(content: @Composable () -> Unit) {
    MaterialTheme(colorScheme = GameTrackerDark, content = content)
}
